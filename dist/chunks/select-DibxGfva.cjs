...
let _base_ui_react_accordion = require("@base-ui/react/accordion");
...
function Accordion({ className, ...props }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_base_ui_react_accordion.Accordion.Root, {
		"data-slot": "accordion",
...
function AccordionItem({ className, ...props }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_base_ui_react_accordion.Accordion.Item, {
...
function AccordionTrigger({ className, children, ...props }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_base_ui_react_accordion.Accordion.Header, {
		className: "flex",
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_base_ui_react_accordion.Accordion.Trigger, {
...
function AccordionContent({ className, children, ...props }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_base_ui_react_accordion.Accordion.Panel, {
...
function Separator({ className, orientation = "horizontal", ...props }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_base_ui_react_separator.Separator, {
		"data-slot": "separator",
		orientation,
...
function ButtonGroupText({ className, render, ...props }) {
	return (0, _base_ui_react_use_render.useRender)({
		defaultTagName: "div",
		props: (0, _base_ui_react_merge_props.mergeProps)({ className: cn("flex items-center gap-2 rounded-lg border bg-muted px-2.5 text-sm font-medium [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4", className) }, props),
		render,
...
function Button(props) {
	return react.default.createElement("button", { ...props });
}
//#endregion
...
function CaptionLabel(props) {
	return react.default.createElement("span", { ...props });
}
//#endregion
...
function Chevron(props) {
	...
	return react.default.createElement("svg", {
		...
		height: size,
		viewBox: "0 0 24 24"
	}, orientation === "up" && react.default.createElement("polygon", { points: "6.77 17 12.5 11.43 18.24 17 20 15.28 12.5 8 5 15.28" }), orientation === "down" && react.default.createElement("polygon", { points: "6.77 8 12.5 13.57 18.24 8 20 9.72 12.5 17 5 9.72" }), orientation === "left" && react.default.createElement("polygon", { points: "16 18.112 9.81111111 12 16 5.87733333 14.0888889 4 6 12 14.0888889 20" }), orientation === "right" && react.default.createElement("polygon", { points: "8 18.112 14.18888889 12 8 5.87733333 9.91111111 4 18 12 9.91111111 20" }));
}
//#endregion
...
function Day(props) {
	...
	return react.default.createElement("td", { ...tdProps });
}
//#endregion
...
function Dropdown(props) {
	...
	return react.default.createElement("span", {
	...
	}, react.default.createElement(components.Select, {
		className: cssClassSelect,
		...selectProps
	}, options?.map(({ value, label, disabled }) => react.default.createElement(components.Option, {
		key: value,
		value,
		disabled
		...
		"aria-hidden": true
	}, selectedOption?.label, react.default.createElement(components.Chevron, {
		orientation: "down",
		size: 18,
...
function DropdownNav(props) {
	return react.default.createElement("div", { ...props });
}
//#endregion
...
function Month(props) {
	...
	return react.default.createElement("div", { ...divProps }, props.children);
}
//#endregion
...
function MonthCaption(props) {
	const { calendarMonth, displayIndex, ...divProps } = props;
	return react.default.createElement("div", { ...divProps });
}
//#endregion
...
function MonthGrid(props) {
	return react.default.createElement("table", { ...props });
}
//#endregion
...
function MonthsDropdown(props) {
	...
	return react.default.createElement(components.Dropdown, { ...props });
}
//#endregion
...
function Nav(props) {
	...
	const handleNextClick = (0, react.useCallback)((e) => {
		if (nextMonth) onNextClick?.(e);
	}, [nextMonth, onNextClick]);
	const handlePreviousClick = (0, react.useCallback)((e) => {
		if (previousMonth) onPreviousClick?.(e);
	}, [previousMonth, onPreviousClick]);
	return react.default.createElement("nav", { ...navProps }, react.default.createElement(components.PreviousMonthButton, {
		type: "button",
	...
	}, react.default.createElement(components.Chevron, {
		disabled: previousMonth ? void 0 : true,
		className: classNames[UI.Chevron],
		orientation: "left"
	})), react.default.createElement(components.NextMonthButton, {
		type: "button",
...
function NextMonthButton(props) {
	const { components } = useDayPicker();
	return react.default.createElement(components.Button, { ...props });
}
//#endregion
...
function Option(props) {
	return react.default.createElement("option", { ...props });
}
//#endregion
...
function Select$1(props) {
	return react.default.createElement("select", { ...props });
}
//#endregion
...
function Week(props) {
	...
	return react.default.createElement("tr", { ...trProps });
}
//#endregion
...
function Weekday(props) {
	return react.default.createElement("th", { ...props });
}
//#endregion
...
function Weekdays(props) {
	return react.default.createElement("thead", { "aria-hidden": true }, react.default.createElement("tr", { ...props }));
}
//#endregion
...
function WeekNumber(props) {
	...
	return react.default.createElement("th", { ...thProps });
}
//#endregion
...
function Weeks(props) {
	return react.default.createElement("tbody", { ...props });
}
//#endregion
...
var custom_components_exports = /* @__PURE__ */ require_chunk.__exportAll({
	Button: () => Button,
...
var formatters_exports = /* @__PURE__ */ require_chunk.__exportAll({
...
var labels_exports = /* @__PURE__ */ require_chunk.__exportAll({
...
function useAnimation(rootElRef, enabled, { classNames, months, focused, dateLib }) {
	...
	const previousMonthsRef = (0, react.useRef)(months);
...
function useCalendar(props, dateLib) {
	...
	const { months, weeks, days, previousMonth, nextMonth } = (0, react.useMemo)(() => {
...
function useFocus(props, calendar, getModifiers, isSelected, dateLib) {
	...
	const [focusedDay, setFocused] = (0, react.useState)(autoFocus ? focusTarget : void 0);
	const blur = () => {
...
function DayPicker(initialProps) {
	...
	const weekdays = (0, react.useMemo)(() => getWeekdays(dateLib, props.ISOWeek, props.broadcastCalendar, props.today), [
		dateLib,
		props.ISOWeek,
		props.broadcastCalendar,
		props.today
	...
	const rootElRef = (0, react.useRef)(null);
	...
	return react.default.createElement(dayPickerContext.Provider, { value: contextValue }, react.default.createElement(components.Root, {
		...
		...dataAttributes
	}, react.default.createElement(components.Months, {
		className: classNames[UI.Months],
		style: styles?.[UI.Months]
	}, !props.hideNavigation && !navLayout && react.default.createElement(components.Nav, {
		...
		return react.default.createElement(components.Month, {
			...
			displayIndex,
			calendarMonth
		}, navLayout === "around" && !props.hideNavigation && displayIndex === 0 && react.default.createElement(components.PreviousMonthButton, {
			type: "button",
			className: classNames[UI.PreviousMonthButton],
			tabIndex: previousMonth ? void 0 : -1,
			"aria-disabled": previousMonth ? void 0 : true,
		...
		})), react.default.createElement(components.MonthCaption, {
			"data-animated-caption": props.animate ? "true" : void 0,
			className: classNames[UI.MonthCaption],
			style: styles?.[UI.MonthCaption],
			calendarMonth,
			displayIndex
		}, captionLayout?.startsWith("dropdown") ? react.default.createElement(components.DropdownNav, {
			className: classNames[UI.Dropdowns],
			style: styles?.[UI.Dropdowns]
		}, (() => {
			const monthControl = captionLayout === "dropdown" || captionLayout === "dropdown-months" ? react.default.createElement(components.MonthsDropdown, {
				key: "month",
			...
			}) : react.default.createElement("span", { key: "month" }, formatMonthDropdown(calendarMonth.date, dateLib));
			const yearControl = captionLayout === "dropdown" || captionLayout === "dropdown-years" ? react.default.createElement(components.YearsDropdown, {
				key: "year",
			...
			}) : react.default.createElement("span", { key: "year" }, formatYearDropdown(calendarMonth.date, dateLib));
		...
		}, formatCaption(calendarMonth.date, dateLib.options, dateLib))) : react.default.createElement(components.CaptionLabel, {
			className: classNames[UI.CaptionLabel],
			role: "status",
			"aria-live": "polite"
		}, formatCaption(calendarMonth.date, dateLib.options, dateLib))), navLayout === "around" && !props.hideNavigation && displayIndex === numberOfMonths - 1 && react.default.createElement(components.NextMonthButton, {
			type: "button",
			className: classNames[UI.NextMonthButton],
			tabIndex: nextMonth ? void 0 : -1,
			"aria-disabled": nextMonth ? void 0 : true,
		...
		})), displayIndex === numberOfMonths - 1 && navLayout === "after" && !props.hideNavigation && react.default.createElement(components.Nav, {
			"data-animated-nav": props.animate ? "true" : void 0,
			className: classNames[UI.Nav],
			style: styles?.[UI.Nav],
			"aria-label": labelNav(),
			...
			previousMonth,
			nextMonth
		}), react.default.createElement(components.MonthGrid, {
			role: "grid",
			"aria-multiselectable": mode === "multiple" || mode === "range",
			"aria-label": labelGrid(calendarMonth.date, dateLib.options, dateLib) || void 0,
			className: classNames[UI.MonthGrid],
			style: styles?.[UI.MonthGrid]
		}, !props.hideWeekdays && react.default.createElement(components.Weekdays, {
			"data-animated-weekdays": props.animate ? "true" : void 0,
			className: classNames[UI.Weekdays],
			style: styles?.[UI.Weekdays]
		}, showWeekNumber && react.default.createElement(components.WeekNumberHeader, {
			"aria-label": labelWeekNumberHeader(dateLib.options),
			className: classNames[UI.WeekNumberHeader],
			style: styles?.[UI.WeekNumberHeader],
			scope: "col"
		}, formatWeekNumberHeader()), weekdays.map((weekday) => react.default.createElement(components.Weekday, {
			"aria-label": labelWeekday(weekday, dateLib.options, dateLib),
			className: classNames[UI.Weekday],
			key: String(weekday),
			style: styles?.[UI.Weekday],
			scope: "col"
		}, formatWeekdayName(weekday, dateLib.options, dateLib)))), react.default.createElement(components.Weeks, {
			"data-animated-weeks": props.animate ? "true" : void 0,
			className: classNames[UI.Weeks],
			style: styles?.[UI.Weeks]
		}, calendarMonth.weeks.map((week) => {
			return react.default.createElement(components.Week, {
				className: classNames[UI.Week],
				key: week.weekNumber,
				style: styles?.[UI.Week],
				week
			}, showWeekNumber && react.default.createElement(components.WeekNumber, {
				week,
				...
				return react.default.createElement(components.Day, {
				...
				}, !modifiers.hidden && isInteractive ? react.default.createElement(components.DayButton, {
	...
	})), props.footer && react.default.createElement(components.Footer, {
...
function Calendar({ className, classNames, showOutsideDays = true, captionLayout = "label", buttonVariant = "ghost", locale, formatters, components, ...props }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DayPicker, {
		showOutsideDays,
		...
		components: {
			...
			Chevron: ({ className, orientation, ...props }) => {
				if (orientation === "left") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChevronLeft, {
					className: cn("size-4", className),
					...props
				});
				if (orientation === "right") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChevronRight, {
					className: cn("size-4", className),
					...props
				});
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChevronDown, {
					className: cn("size-4", className),
					...props
				});
			},
			DayButton: ({ ...props }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CalendarDayButton, {
				locale,
				...props
			}),
...
function CarouselPrevious({ className, variant = "outline", size = "icon-sm", ...props }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Button$1, {
		...
		onClick: scrollPrev,
		...props,
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChevronLeft, {}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
			className: "sr-only",
...
function CarouselNext({ className, variant = "outline", size = "icon-sm", ...props }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Button$1, {
		...
		onClick: scrollNext,
		...props,
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChevronRight, {}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
			className: "sr-only",
			children: "Next slide"
		})]
	});
...
var Select = _base_ui_react_select.Select.Root;
...
function SelectContent({ className, children, side = "bottom", sideOffset = 4, align = "center", alignOffset = 0, alignItemWithTrigger = true, ...props }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_base_ui_react_select.Select.Portal, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_base_ui_react_select.Select.Positioner, {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_base_ui_react_select.Select.Popup, {
			...
			className: cn("relative isolate z-50 max-h-(--available-height) w-(--anchor-width) max-w-(--available-width) origin-(--transform-origin) overflow-hidden rounded-lg bg-popover text-popover-foreground shadow-md ring-1 ring-foreground/10 duration-100 data-[side=bottom]:slide-in-from-top-2 data-[side=inline-end]:slide-in-from-left-2 data-[side=inline-start]:slide-in-from-right-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95", className),
			...props,
			children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SelectScrollUpButton, {}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_base_ui_react_select.Select.List, {
					className: cn("no-scrollbar max-h-[min(calc(--spacing(72)---spacing(9)),calc(var(--available-height)---spacing(9)))] scroll-py-1 overflow-y-auto overscroll-contain p-1"),
					children
				}),
...
function SelectItem({ className, children, ...props }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_base_ui_react_select.Select.Item, {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_base_ui_react_select.Select.ItemText, {
			...
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Check, { className: "pointer-events-none size-4" })
		})]
	});
}
...
function SelectScrollUpButton({ className, ...props }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_base_ui_react_select.Select.ScrollUpArrow, {
		...
		className: cn("flex w-full cursor-default items-center justify-center py-1 text-muted-foreground", className),
		...props,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChevronUp, { className: "size-4" })
	});
}
function SelectScrollDownButton({ className, ...props }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_base_ui_react_select.Select.ScrollDownArrow, {
		...
		className: cn("flex w-full cursor-default items-center justify-center py-1 text-muted-foreground", className),
		...props,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChevronDown, { className: "size-4" })
	});
}
//#endregion
...
Object.defineProperty(exports, "ButtonGroupSeparator", {
	enumerable: true,
	get: function() {
		return ButtonGroupSeparator;
	}
});
Object.defineProperty(exports, "ButtonGroupText", {
	enumerable: true,
	get: function() {
...
Object.defineProperty(exports, "badgeVariantsConfig", {
	enumerable: true,
	get: function() {
		return badgeVariantsConfig;
	}
});
...
Object.defineProperty(exports, "buttonGroupVariantsConfig", {
	enumerable: true,
	get: function() {
		return buttonGroupVariantsConfig;
	}
});
...
Object.defineProperty(exports, "createLucideIcon", {
	enumerable: true,
	get: function() {
