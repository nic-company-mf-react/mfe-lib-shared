...
const require_ui = require("./ui-CWU5C_by.cjs");
const require_context = require("./context-CVUDN6YM.cjs");
const require_I18nProvider = require("./I18nProvider-DvFZK71p.cjs");
...
function AppProviders({ children, queryConfig, i18nInstance }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(require_context.ThemeProvider, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_I18nProvider.I18nProvider, {
		i18n: i18nInstance,
	...
	}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_ui.Toaster, {})] });
}
//#endregion
