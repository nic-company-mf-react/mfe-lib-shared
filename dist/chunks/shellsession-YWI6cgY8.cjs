const require_shellscript = require("./shellscript-CQEOGZxt.cjs");
...
var shellsession_default = [...require_shellscript.shellscript_default, lang];
//#endregion
exports.default = shellsession_default;
