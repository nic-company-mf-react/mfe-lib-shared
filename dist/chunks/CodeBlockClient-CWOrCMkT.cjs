...
const require_I18nProvider = require("./I18nProvider-BvIjD_y8.cjs");
...
var bundledLanguagesInfo = [
	{
		"id": "abap",
		"name": "ABAP",
		"import": (() => Promise.resolve().then(() => require("./abap-KEvSx_qA.cjs")))
	},
	{
		"id": "actionscript-3",
		"name": "ActionScript",
		"import": (() => Promise.resolve().then(() => require("./actionscript-3-DLXH2DEK.cjs")))
	},
	{
		"id": "ada",
		"name": "Ada",
		"import": (() => Promise.resolve().then(() => require("./ada-DXWS21Qc.cjs")))
	},
	{
		"id": "angular-html",
		"name": "Angular HTML",
		"import": (() => Promise.resolve().then(() => require("./angular-html-DjHK2Sy2.cjs")).then((n) => n.angular_html_exports))
	},
	{
		"id": "angular-ts",
		"name": "Angular TypeScript",
		"import": (() => Promise.resolve().then(() => require("./angular-ts-C-j0N1YT.cjs")))
	},
	{
		"id": "apache",
		"name": "Apache Conf",
		"import": (() => Promise.resolve().then(() => require("./apache-Ch1Vi6-m.cjs")))
	},
	{
		"id": "apex",
		"name": "Apex",
		"import": (() => Promise.resolve().then(() => require("./apex-B4c3EwWr.cjs")))
	},
	{
		"id": "apl",
		"name": "APL",
		"import": (() => Promise.resolve().then(() => require("./apl-DNW-aNn4.cjs")))
	},
	{
		"id": "applescript",
		"name": "AppleScript",
		"import": (() => Promise.resolve().then(() => require("./applescript-BX9_GfcE.cjs")))
	},
	{
		"id": "ara",
		"name": "Ara",
		"import": (() => Promise.resolve().then(() => require("./ara-DY6e9ab3.cjs")))
	},
	{
		"id": "asciidoc",
		"name": "AsciiDoc",
		"aliases": ["adoc"],
		"import": (() => Promise.resolve().then(() => require("./asciidoc-bCTavW7A.cjs")))
	},
	{
		"id": "asm",
		"name": "Assembly",
		"import": (() => Promise.resolve().then(() => require("./asm-BTG0gWpu.cjs")))
	},
	{
		"id": "astro",
		"name": "Astro",
		"import": (() => Promise.resolve().then(() => require("./astro-OMOn2uuu.cjs")))
	},
	{
		"id": "awk",
		"name": "AWK",
		"import": (() => Promise.resolve().then(() => require("./awk-Bp2sBJQR.cjs")))
	},
	{
		"id": "ballerina",
		"name": "Ballerina",
		"import": (() => Promise.resolve().then(() => require("./ballerina-D4NgezG1.cjs")))
	},
	{
		"id": "bat",
		"name": "Batch File",
		"aliases": ["batch"],
		"import": (() => Promise.resolve().then(() => require("./bat-DXucG8Og.cjs")))
	},
	{
		"id": "beancount",
		"name": "Beancount",
		"import": (() => Promise.resolve().then(() => require("./beancount-B8w4VNV4.cjs")))
	},
	{
		"id": "berry",
		"name": "Berry",
		"aliases": ["be"],
		"import": (() => Promise.resolve().then(() => require("./berry-CUyvLnXB.cjs")))
	},
	{
		"id": "bibtex",
		"name": "BibTeX",
		"import": (() => Promise.resolve().then(() => require("./bibtex-qWDWdrvv.cjs")))
	},
	{
		"id": "bicep",
		"name": "Bicep",
		"import": (() => Promise.resolve().then(() => require("./bicep-DR2tEhR8.cjs")))
	},
	{
		"id": "bird2",
		"name": "BIRD2 Configuration",
		"aliases": ["bird"],
		"import": (() => Promise.resolve().then(() => require("./bird2-BCjXRTqG.cjs")))
	},
	{
		"id": "blade",
		"name": "Blade",
		"import": (() => Promise.resolve().then(() => require("./blade-CJ6mrnH0.cjs")))
	},
	{
		"id": "bsl",
		"name": "1C (Enterprise)",
		"aliases": ["1c"],
		"import": (() => Promise.resolve().then(() => require("./bsl-CSFOTerM.cjs")))
	},
	{
		"id": "c",
		"name": "C",
		"import": (() => Promise.resolve().then(() => require("./c-Cldp3znM.cjs")).then((n) => n.c_exports))
	},
	{
		"id": "c3",
		"name": "C3",
		"import": (() => Promise.resolve().then(() => require("./c3-C5bo976T.cjs")))
	},
	{
		"id": "cadence",
		"name": "Cadence",
		"aliases": ["cdc"],
		"import": (() => Promise.resolve().then(() => require("./cadence-BSp3_c7y.cjs")))
	},
	{
		"id": "cairo",
		"name": "Cairo",
		"import": (() => Promise.resolve().then(() => require("./cairo-DvO3tg5y.cjs")))
	},
	{
		"id": "clarity",
		"name": "Clarity",
		"import": (() => Promise.resolve().then(() => require("./clarity-ZT_2r-OT.cjs")))
	},
	{
		"id": "clojure",
		"name": "Clojure",
		"aliases": ["clj"],
		"import": (() => Promise.resolve().then(() => require("./clojure-B7IHkb9c.cjs")))
	},
	{
		"id": "cmake",
		"name": "CMake",
		"import": (() => Promise.resolve().then(() => require("./cmake-MM7Wt9Ts.cjs")))
	},
	{
		"id": "cobol",
		"name": "COBOL",
		"import": (() => Promise.resolve().then(() => require("./cobol-B5_mYsN9.cjs")))
	},
	{
		"id": "codeowners",
		"name": "CODEOWNERS",
		"import": (() => Promise.resolve().then(() => require("./codeowners-YPh_7Wkz.cjs")))
	},
	{
		"id": "codeql",
		"name": "CodeQL",
		"aliases": ["ql"],
		"import": (() => Promise.resolve().then(() => require("./codeql-BSEwAoL2.cjs")))
	},
	{
		"id": "coffee",
		"name": "CoffeeScript",
		"aliases": ["coffeescript"],
		"import": (() => Promise.resolve().then(() => require("./coffee-a2rQ0RqY.cjs")))
	},
	{
		"id": "common-lisp",
		"name": "Common Lisp",
		"aliases": ["lisp"],
		"import": (() => Promise.resolve().then(() => require("./common-lisp-DspWYz6m.cjs")))
	},
	{
		"id": "coq",
		"name": "Coq",
		"import": (() => Promise.resolve().then(() => require("./coq-D_P0Ff53.cjs")))
	},
	{
		"id": "cpp",
		"name": "C++",
		"aliases": ["c++"],
		"import": (() => Promise.resolve().then(() => require("./cpp-BRlYFFQX.cjs")).then((n) => n.cpp_exports))
	},
	{
		"id": "crystal",
		"name": "Crystal",
		"import": (() => Promise.resolve().then(() => require("./crystal-9frtWgHY.cjs")))
	},
	{
		"id": "csharp",
		"name": "C#",
		"aliases": ["c#", "cs"],
		"import": (() => Promise.resolve().then(() => require("./csharp-BsPD43Fw.cjs")))
	},
	{
		"id": "css",
		"name": "CSS",
		"import": (() => Promise.resolve().then(() => require("./css-BbJ5ivkd.cjs")).then((n) => n.css_exports))
	},
	{
		"id": "csv",
		"name": "CSV",
		"import": (() => Promise.resolve().then(() => require("./csv-5Bjtxkgl.cjs")))
	},
	{
		"id": "cue",
		"name": "CUE",
		"import": (() => Promise.resolve().then(() => require("./cue-DyoegsXq.cjs")))
	},
	{
		"id": "cypher",
		"name": "Cypher",
		"aliases": ["cql"],
		"import": (() => Promise.resolve().then(() => require("./cypher-DSBSrRdU.cjs")))
	},
	{
		"id": "d",
		"name": "D",
		"import": (() => Promise.resolve().then(() => require("./d-szIwRiBk.cjs")))
	},
	{
		"id": "dart",
		"name": "Dart",
		"import": (() => Promise.resolve().then(() => require("./dart-6qFnPCce.cjs")))
	},
	{
		"id": "dax",
		"name": "DAX",
		"import": (() => Promise.resolve().then(() => require("./dax-D7VfnYli.cjs")))
	},
	{
		"id": "desktop",
		"name": "Desktop",
		"import": (() => Promise.resolve().then(() => require("./desktop-VXXOJ0QZ.cjs")))
	},
	{
		"id": "diff",
		"name": "Diff",
		"import": (() => Promise.resolve().then(() => require("./diff-Dqv0fp2e.cjs")))
	},
	{
		"id": "docker",
		"name": "Dockerfile",
		"aliases": ["dockerfile"],
		"import": (() => Promise.resolve().then(() => require("./docker-BoRdPi4r.cjs")))
	},
	{
		"id": "dotenv",
		"name": "dotEnv",
		"import": (() => Promise.resolve().then(() => require("./dotenv-CDWMOyad.cjs")))
	},
	{
		"id": "dream-maker",
		"name": "Dream Maker",
		"import": (() => Promise.resolve().then(() => require("./dream-maker-B-ZzchSt.cjs")))
	},
	{
		"id": "edge",
		"name": "Edge",
		"import": (() => Promise.resolve().then(() => require("./edge-WGcnGBq9.cjs")))
	},
	{
		"id": "elixir",
		"name": "Elixir",
		"import": (() => Promise.resolve().then(() => require("./elixir-y3LawLav.cjs")))
	},
	{
		"id": "elm",
		"name": "Elm",
		"import": (() => Promise.resolve().then(() => require("./elm--PmHYr6z.cjs")))
	},
	{
		"id": "emacs-lisp",
		"name": "Emacs Lisp",
		"aliases": ["elisp"],
		"import": (() => Promise.resolve().then(() => require("./emacs-lisp-DolvG_M_.cjs")))
	},
	{
		"id": "erb",
		"name": "ERB",
		"import": (() => Promise.resolve().then(() => require("./erb-CnIIirc7.cjs")))
	},
	{
		"id": "erlang",
		"name": "Erlang",
		"aliases": ["erl"],
		"import": (() => Promise.resolve().then(() => require("./erlang-DjlXrQWJ.cjs")))
	},
	{
		"id": "fennel",
		"name": "Fennel",
		"import": (() => Promise.resolve().then(() => require("./fennel-7xP9TT4Z.cjs")))
	},
	{
		"id": "fish",
		"name": "Fish",
		"import": (() => Promise.resolve().then(() => require("./fish-7oiCBg8L.cjs")))
	},
	{
		"id": "fluent",
		"name": "Fluent",
		"aliases": ["ftl"],
		"import": (() => Promise.resolve().then(() => require("./fluent-BbAvExWB.cjs")))
	},
	{
		...
		"import": (() => Promise.resolve().then(() => require("./fortran-fixed-form-ChJdFUO_.cjs")))
	},
	{
		...
		"import": (() => Promise.resolve().then(() => require("./fortran-free-form-BWZQQ_WG.cjs")))
	},
	{
		"id": "fsharp",
		"name": "F#",
		"aliases": ["f#", "fs"],
		"import": (() => Promise.resolve().then(() => require("./fsharp-CyieKi-s.cjs")))
	},
	{
		"id": "gdresource",
		"name": "GDResource",
		"aliases": ["tscn", "tres"],
		"import": (() => Promise.resolve().then(() => require("./gdresource-FJurfIDa.cjs")))
	},
	{
		"id": "gdscript",
		"name": "GDScript",
		"aliases": ["gd"],
		"import": (() => Promise.resolve().then(() => require("./gdscript-CrFvKk1x.cjs")))
	},
	{
		"id": "gdshader",
		"name": "GDShader",
		"import": (() => Promise.resolve().then(() => require("./gdshader-D1LrKqlZ.cjs")))
	},
	{
		"id": "genie",
		"name": "Genie",
		"import": (() => Promise.resolve().then(() => require("./genie-HgV1B6ou.cjs")))
	},
	{
		"id": "gherkin",
		"name": "Gherkin",
		"import": (() => Promise.resolve().then(() => require("./gherkin-B5yWXQ4a.cjs")))
	},
	{
		"id": "git-commit",
		"name": "Git Commit Message",
		"import": (() => Promise.resolve().then(() => require("./git-commit-Uyw4JY53.cjs")))
	},
	{
		"id": "git-rebase",
		"name": "Git Rebase Message",
		"import": (() => Promise.resolve().then(() => require("./git-rebase-CfpWkT0C.cjs")))
	},
	{
		"id": "gleam",
		"name": "Gleam",
		"import": (() => Promise.resolve().then(() => require("./gleam-BfzzG1dc.cjs")))
	},
	{
		"id": "glimmer-js",
		"name": "Glimmer JS",
		"aliases": ["gjs"],
		"import": (() => Promise.resolve().then(() => require("./glimmer-js-31TTY4Vu.cjs")))
	},
	{
		"id": "glimmer-ts",
		"name": "Glimmer TS",
		"aliases": ["gts"],
		"import": (() => Promise.resolve().then(() => require("./glimmer-ts-ClhgiDsO.cjs")))
	},
	{
		"id": "glsl",
		"name": "GLSL",
		"import": (() => Promise.resolve().then(() => require("./glsl-DoezcrGz.cjs")).then((n) => n.glsl_exports))
	},
	{
		"id": "gn",
		"name": "GN",
		"import": (() => Promise.resolve().then(() => require("./gn-D6i8kmYz.cjs")))
	},
	{
		"id": "gnuplot",
		"name": "Gnuplot",
		"import": (() => Promise.resolve().then(() => require("./gnuplot-JHa1O5c8.cjs")))
	},
	{
		"id": "go",
		"name": "Go",
		"import": (() => Promise.resolve().then(() => require("./go-DHBwX4FZ.cjs")))
	},
	{
		"id": "graphql",
		"name": "GraphQL",
		"aliases": ["gql"],
		"import": (() => Promise.resolve().then(() => require("./graphql-gRpC_vaL.cjs")).then((n) => n.graphql_exports))
	},
	{
		"id": "groovy",
		"name": "Groovy",
		"import": (() => Promise.resolve().then(() => require("./groovy-DO3XnQhL.cjs")))
	},
	{
		"id": "hack",
		"name": "Hack",
		"import": (() => Promise.resolve().then(() => require("./hack-BHSJN3uG.cjs")))
	},
	{
		"id": "haml",
		"name": "Ruby Haml",
		"import": (() => Promise.resolve().then(() => require("./haml-DdNHpn56.cjs")).then((n) => n.haml_exports))
	},
	{
		"id": "handlebars",
		"name": "Handlebars",
		"aliases": ["hbs"],
		"import": (() => Promise.resolve().then(() => require("./handlebars-DrqlbUdc.cjs")))
	},
	{
		"id": "haskell",
		"name": "Haskell",
		"aliases": ["hs"],
		"import": (() => Promise.resolve().then(() => require("./haskell-kQyaxUcL.cjs")))
	},
	{
		"id": "haxe",
		"name": "Haxe",
		"import": (() => Promise.resolve().then(() => require("./haxe-gou8OdUQ.cjs")))
	},
	{
		"id": "hcl",
		"name": "HashiCorp HCL",
		"import": (() => Promise.resolve().then(() => require("./hcl-BgNm0l7P.cjs")))
	},
	{
		"id": "hjson",
		"name": "Hjson",
		"import": (() => Promise.resolve().then(() => require("./hjson-3TJytNS_.cjs")))
	},
	{
		"id": "hlsl",
		"name": "HLSL",
		"import": (() => Promise.resolve().then(() => require("./hlsl-Dt8MdbgC.cjs")))
	},
	{
		"id": "html",
		"name": "HTML",
		"import": (() => Promise.resolve().then(() => require("./html-C76uAgtS.cjs")).then((n) => n.html_exports))
	},
	{
		"id": "html-derivative",
		"name": "HTML (Derivative)",
		"import": (() => Promise.resolve().then(() => require("./html-derivative-CNVl3Yi5.cjs")))
	},
	{
		"id": "http",
		"name": "HTTP",
		"import": (() => Promise.resolve().then(() => require("./http-JGh_RJA5.cjs")))
	},
	{
		"id": "hurl",
		"name": "Hurl",
		"import": (() => Promise.resolve().then(() => require("./hurl-CfxbGNa2.cjs")))
	},
	{
		"id": "hxml",
		"name": "HXML",
		"import": (() => Promise.resolve().then(() => require("./hxml-FI4Qj1op.cjs")))
	},
	{
		"id": "hy",
		"name": "Hy",
		"import": (() => Promise.resolve().then(() => require("./hy-CPirtG2h.cjs")))
	},
	{
		"id": "imba",
		"name": "Imba",
		"import": (() => Promise.resolve().then(() => require("./imba-3OrnCPQf.cjs")))
	},
	{
		"id": "ini",
		"name": "INI",
		"aliases": ["properties"],
		"import": (() => Promise.resolve().then(() => require("./ini-_WvsJmS9.cjs")))
	},
	{
		"id": "java",
		"name": "Java",
		"import": (() => Promise.resolve().then(() => require("./java-BJm8Rpoe.cjs")).then((n) => n.java_exports))
	},
	{
		"id": "javascript",
		"name": "JavaScript",
		...
		"import": (() => Promise.resolve().then(() => require("./javascript-DF51iSEH.cjs")).then((n) => n.javascript_exports))
	},
	{
		"id": "jinja",
		"name": "Jinja",
		"import": (() => Promise.resolve().then(() => require("./jinja-48MGTorI.cjs")))
	},
	{
		"id": "jison",
		"name": "Jison",
		"import": (() => Promise.resolve().then(() => require("./jison-D4b9Gc43.cjs")))
	},
	{
		"id": "json",
		"name": "JSON",
		"import": (() => Promise.resolve().then(() => require("./json-Dbtq9udi.cjs")).then((n) => n.json_exports))
	},
	{
		"id": "json5",
		"name": "JSON5",
		"import": (() => Promise.resolve().then(() => require("./json5-C8FRypcq.cjs")))
	},
	{
		"id": "jsonc",
		"name": "JSON with Comments",
		"import": (() => Promise.resolve().then(() => require("./jsonc-CrNwCYEp.cjs")))
	},
	{
		"id": "jsonl",
		"name": "JSON Lines",
		"import": (() => Promise.resolve().then(() => require("./jsonl-IuKdtyQ9.cjs")))
	},
	{
		"id": "jsonnet",
		"name": "Jsonnet",
		"import": (() => Promise.resolve().then(() => require("./jsonnet-Bch9EbT2.cjs")))
	},
	{
		"id": "jssm",
		"name": "JSSM",
		"aliases": ["fsl"],
		"import": (() => Promise.resolve().then(() => require("./jssm-D03zBg8m.cjs")))
	},
	{
		"id": "jsx",
		"name": "JSX",
		"import": (() => Promise.resolve().then(() => require("./jsx-Du-KuLPu.cjs")).then((n) => n.jsx_exports))
	},
	{
		"id": "julia",
		"name": "Julia",
		"aliases": ["jl"],
		"import": (() => Promise.resolve().then(() => require("./julia-CpEdiPor.cjs")))
	},
	{
		"id": "just",
		"name": "Just",
		"import": (() => Promise.resolve().then(() => require("./just-BD6nf9-k.cjs")))
	},
	{
		"id": "kdl",
		"name": "KDL",
		"import": (() => Promise.resolve().then(() => require("./kdl-Bc1qztfh.cjs")))
	},
	{
		"id": "kotlin",
		"name": "Kotlin",
		"aliases": ["kt", "kts"],
		"import": (() => Promise.resolve().then(() => require("./kotlin-rYKXLWDc.cjs")))
	},
	{
		"id": "kusto",
		"name": "Kusto",
		"aliases": ["kql"],
		"import": (() => Promise.resolve().then(() => require("./kusto-B4aGv7Nb.cjs")))
	},
	{
		"id": "latex",
		"name": "LaTeX",
		"import": (() => Promise.resolve().then(() => require("./latex-I8ChXfLE.cjs")))
	},
	{
		"id": "lean",
		"name": "Lean 4",
		"aliases": ["lean4"],
		"import": (() => Promise.resolve().then(() => require("./lean-CFeLcHEJ.cjs")))
	},
	{
		"id": "less",
		"name": "Less",
		"import": (() => Promise.resolve().then(() => require("./less-Dh-XKtWO.cjs")))
	},
	{
		"id": "liquid",
		"name": "Liquid",
		"import": (() => Promise.resolve().then(() => require("./liquid-_wQsrumh.cjs")))
	},
	{
		"id": "llvm",
		"name": "LLVM IR",
		"import": (() => Promise.resolve().then(() => require("./llvm-CgGXfSZc.cjs")))
	},
	{
		"id": "log",
		"name": "Log file",
		"import": (() => Promise.resolve().then(() => require("./log-CGffbzl9.cjs")))
	},
	{
		"id": "logo",
		"name": "Logo",
		"import": (() => Promise.resolve().then(() => require("./logo-BkIoZljZ.cjs")))
	},
	{
		"id": "lua",
		"name": "Lua",
		"import": (() => Promise.resolve().then(() => require("./lua-DDmSyvEv.cjs")).then((n) => n.lua_exports))
	},
	{
		"id": "luau",
		"name": "Luau",
		"import": (() => Promise.resolve().then(() => require("./luau-BmTv-Uqj.cjs")))
	},
	{
		"id": "make",
		"name": "Makefile",
		"aliases": ["makefile"],
		"import": (() => Promise.resolve().then(() => require("./make-BQHuvwWY.cjs")))
	},
	{
		"id": "markdown",
		"name": "Markdown",
		"aliases": ["md"],
		"import": (() => Promise.resolve().then(() => require("./markdown-CZKRkMM1.cjs")))
	},
	{
		"id": "marko",
		"name": "Marko",
		"import": (() => Promise.resolve().then(() => require("./marko-BAKMCVGB.cjs")))
	},
	{
		"id": "matlab",
		"name": "MATLAB",
		"import": (() => Promise.resolve().then(() => require("./matlab-lPSG3iHe.cjs")))
	},
	{
		"id": "mdc",
		"name": "MDC",
		"import": (() => Promise.resolve().then(() => require("./mdc-B1p2iYeU.cjs")))
	},
	{
		"id": "mdx",
		"name": "MDX",
		"import": (() => Promise.resolve().then(() => require("./mdx-Dy8ye950.cjs")))
	},
	{
		"id": "mermaid",
		"name": "Mermaid",
		"aliases": ["mmd"],
		"import": (() => Promise.resolve().then(() => require("./mermaid-C2iYZLD0.cjs")))
	},
	{
		"id": "mipsasm",
		"name": "MIPS Assembly",
		"aliases": ["mips"],
		"import": (() => Promise.resolve().then(() => require("./mipsasm-DV76EdEL.cjs")))
	},
	{
		"id": "mojo",
		"name": "Mojo",
		"import": (() => Promise.resolve().then(() => require("./mojo-Drqn33AO.cjs")))
	},
	{
		"id": "moonbit",
		"name": "MoonBit",
		"aliases": ["mbt", "mbti"],
		"import": (() => Promise.resolve().then(() => require("./moonbit-B3Cuse7J.cjs")))
	},
	{
		"id": "move",
		"name": "Move",
		"import": (() => Promise.resolve().then(() => require("./move-DF4acjOK.cjs")))
	},
	{
		"id": "narrat",
		"name": "Narrat Language",
		"aliases": ["nar"],
		"import": (() => Promise.resolve().then(() => require("./narrat-D-Pjj9wP.cjs")))
	},
	{
		"id": "nextflow",
		"name": "Nextflow",
		"aliases": ["nf"],
		"import": (() => Promise.resolve().then(() => require("./nextflow-CYHYa4hG.cjs")))
	},
	{
		"id": "nextflow-groovy",
		"name": "Nextflow Groovy",
		"import": (() => Promise.resolve().then(() => require("./nextflow-groovy-BgPLI5lP.cjs")))
	},
	{
		"id": "nginx",
		"name": "Nginx",
		"import": (() => Promise.resolve().then(() => require("./nginx-DlRCQyke.cjs")))
	},
	{
		"id": "nim",
		"name": "Nim",
		"import": (() => Promise.resolve().then(() => require("./nim-DOHOb2o3.cjs")))
	},
	{
		"id": "nix",
		"name": "Nix",
		"import": (() => Promise.resolve().then(() => require("./nix-DGc9S5I7.cjs")))
	},
	{
		"id": "nushell",
		"name": "nushell",
		"aliases": ["nu"],
		"import": (() => Promise.resolve().then(() => require("./nushell-DiAZcgN-.cjs")))
	},
	{
		"id": "objective-c",
		"name": "Objective-C",
		"aliases": ["objc"],
		"import": (() => Promise.resolve().then(() => require("./objective-c-DC5y8dap.cjs")))
	},
	{
		"id": "objective-cpp",
		"name": "Objective-C++",
		"import": (() => Promise.resolve().then(() => require("./objective-cpp-CYTXng8p.cjs")))
	},
	{
		"id": "ocaml",
		"name": "OCaml",
		"import": (() => Promise.resolve().then(() => require("./ocaml-8cfLwYgp.cjs")))
	},
	{
		"id": "odin",
		"name": "Odin",
		"import": (() => Promise.resolve().then(() => require("./odin-BdfU5adr.cjs")))
	},
	{
		"id": "openscad",
		"name": "OpenSCAD",
		"aliases": ["scad"],
		"import": (() => Promise.resolve().then(() => require("./openscad-RCLT6b_H.cjs")))
	},
	{
		"id": "pascal",
		"name": "Pascal",
		"import": (() => Promise.resolve().then(() => require("./pascal-SieDLQFr.cjs")))
	},
	{
		"id": "perl",
		"name": "Perl",
		"import": (() => Promise.resolve().then(() => require("./perl-3wzzRwgQ.cjs")))
	},
	{
		"id": "php",
		"name": "PHP",
		"import": (() => Promise.resolve().then(() => require("./php-BjGKsaJy.cjs")))
	},
	{
		"id": "pkl",
		"name": "Pkl",
		"import": (() => Promise.resolve().then(() => require("./pkl-CXIhxLyl.cjs")))
	},
	{
		"id": "plsql",
		"name": "PL/SQL",
		"import": (() => Promise.resolve().then(() => require("./plsql-Clw6NmZK.cjs")))
	},
	{
		"id": "po",
		"name": "Gettext PO",
		"aliases": ["pot", "potx"],
		"import": (() => Promise.resolve().then(() => require("./po-CP3NampN.cjs")))
	},
	{
		"id": "polar",
		"name": "Polar",
		"import": (() => Promise.resolve().then(() => require("./polar-CiAOyS0g.cjs")))
	},
	{
		"id": "postcss",
		"name": "PostCSS",
		"import": (() => Promise.resolve().then(() => require("./postcss-CXy1jgIY.cjs")))
	},
	{
		"id": "powerquery",
		"name": "PowerQuery",
		"import": (() => Promise.resolve().then(() => require("./powerquery-HD7b2twz.cjs")))
	},
	{
		"id": "powershell",
		"name": "PowerShell",
		"aliases": ["ps", "ps1"],
		"import": (() => Promise.resolve().then(() => require("./powershell-_OescwRA.cjs")))
	},
	{
		"id": "prisma",
		"name": "Prisma",
		"import": (() => Promise.resolve().then(() => require("./prisma-DWk-Bl0i.cjs")))
	},
	{
		"id": "prolog",
		"name": "Prolog",
		"import": (() => Promise.resolve().then(() => require("./prolog-6BF_9KGc.cjs")))
	},
	{
		"id": "proto",
		"name": "Protocol Buffer 3",
		"aliases": ["protobuf"],
		"import": (() => Promise.resolve().then(() => require("./proto-DR507EJU.cjs")))
	},
	{
		"id": "pug",
		"name": "Pug",
		"aliases": ["jade"],
		"import": (() => Promise.resolve().then(() => require("./pug-DEIsPLyb.cjs")))
	},
	{
		"id": "puppet",
		"name": "Puppet",
		"import": (() => Promise.resolve().then(() => require("./puppet-CczmMCYz.cjs")))
	},
	{
		"id": "purescript",
		"name": "PureScript",
		"import": (() => Promise.resolve().then(() => require("./purescript-CT1vZV6W.cjs")))
	},
	{
		"id": "python",
		"name": "Python",
		"aliases": ["py"],
		"import": (() => Promise.resolve().then(() => require("./python-9zA7kdoC.cjs")))
	},
	{
		"id": "qml",
		"name": "QML",
		"import": (() => Promise.resolve().then(() => require("./qml-B0RoO_0I.cjs")))
	},
	{
		"id": "qmldir",
		"name": "QML Directory",
		"import": (() => Promise.resolve().then(() => require("./qmldir-BUsK1OXP.cjs")))
	},
	{
		"id": "qss",
		"name": "Qt Style Sheets",
		"import": (() => Promise.resolve().then(() => require("./qss-BdAk-U-4.cjs")))
	},
	{
		"id": "r",
		"name": "R",
		"import": (() => Promise.resolve().then(() => require("./r-BHDs_aTb.cjs")).then((n) => n.r_exports))
	},
	{
		"id": "racket",
		"name": "Racket",
		"import": (() => Promise.resolve().then(() => require("./racket-B5UK31-p.cjs")))
	},
	{
		"id": "raku",
		"name": "Raku",
		"aliases": ["perl6"],
		"import": (() => Promise.resolve().then(() => require("./raku-D8Z3vUue.cjs")))
	},
	{
		"id": "razor",
		"name": "ASP.NET Razor",
		"import": (() => Promise.resolve().then(() => require("./razor-B32FBBVn.cjs")))
	},
	{
		"id": "reg",
		"name": "Windows Registry Script",
		"import": (() => Promise.resolve().then(() => require("./reg-C4XN5Qn8.cjs")))
	},
	{
		"id": "regexp",
		"name": "RegExp",
		"aliases": ["regex"],
		"import": (() => Promise.resolve().then(() => require("./regexp-rAoqPpKx.cjs")).then((n) => n.regexp_exports))
	},
	{
		"id": "rel",
		"name": "Rel",
		"import": (() => Promise.resolve().then(() => require("./rel-CBDGLpGN.cjs")))
	},
	{
		"id": "riscv",
		"name": "RISC-V",
		"import": (() => Promise.resolve().then(() => require("./riscv-rKfVnM5q.cjs")))
	},
	{
		"id": "ron",
		"name": "RON",
		"import": (() => Promise.resolve().then(() => require("./ron-Dxq066OH.cjs")))
	},
	{
		"id": "rosmsg",
		"name": "ROS Interface",
		"import": (() => Promise.resolve().then(() => require("./rosmsg-PFZ1Epnl.cjs")))
	},
	{
		"id": "rst",
		"name": "reStructuredText",
		"import": (() => Promise.resolve().then(() => require("./rst-idQqnWw9.cjs")))
	},
	{
		"id": "ruby",
		"name": "Ruby",
		"aliases": ["rb"],
		"import": (() => Promise.resolve().then(() => require("./ruby-CeX5tJoX.cjs")))
	},
	{
		"id": "rust",
		"name": "Rust",
		"aliases": ["rs"],
		"import": (() => Promise.resolve().then(() => require("./rust-CsWXzD3P.cjs")))
	},
	{
		"id": "sas",
		"name": "SAS",
		"import": (() => Promise.resolve().then(() => require("./sas-DrqZqhJy.cjs")))
	},
	{
		"id": "sass",
		"name": "Sass",
		"import": (() => Promise.resolve().then(() => require("./sass-C3cR6U-X.cjs")))
	},
	{
		"id": "scala",
		"name": "Scala",
		"import": (() => Promise.resolve().then(() => require("./scala-DgQhohdW.cjs")))
	},
	{
		"id": "scheme",
		"name": "Scheme",
		"import": (() => Promise.resolve().then(() => require("./scheme-bhWdxhVB.cjs")))
	},
	{
		"id": "scss",
		"name": "SCSS",
		"import": (() => Promise.resolve().then(() => require("./scss-CrFPQ6hy.cjs")).then((n) => n.scss_exports))
	},
	{
		"id": "sdbl",
		"name": "1C (Query)",
		"aliases": ["1c-query"],
		"import": (() => Promise.resolve().then(() => require("./sdbl-CrNzXihr.cjs")))
	},
	{
		"id": "shaderlab",
		"name": "ShaderLab",
		"aliases": ["shader"],
		"import": (() => Promise.resolve().then(() => require("./shaderlab-VkE6NBVF.cjs")))
	},
	{
		"id": "shellscript",
		"name": "Shell",
		...
		"import": (() => Promise.resolve().then(() => require("./shellscript-Cm_VW6mZ.cjs")).then((n) => n.shellscript_exports))
	},
	{
		"id": "shellsession",
		"name": "Shell Session",
		"aliases": ["console"],
		"import": (() => Promise.resolve().then(() => require("./shellsession-DjT7ZbN8.cjs")))
	},
	{
		"id": "smalltalk",
		"name": "Smalltalk",
		"import": (() => Promise.resolve().then(() => require("./smalltalk-DbyvTPkA.cjs")))
	},
	{
		"id": "solidity",
		"name": "Solidity",
		"import": (() => Promise.resolve().then(() => require("./solidity-BO3ByPIF.cjs")))
	},
	{
		"id": "soy",
		"name": "Closure Templates",
		"aliases": ["closure-templates"],
		"import": (() => Promise.resolve().then(() => require("./soy-D_fc5fZt.cjs")))
	},
	{
		"id": "sparql",
		"name": "SPARQL",
		"import": (() => Promise.resolve().then(() => require("./sparql-CyafXAeJ.cjs")))
	},
	{
		"id": "splunk",
		"name": "Splunk Query Language",
		"aliases": ["spl"],
		"import": (() => Promise.resolve().then(() => require("./splunk-DMeP7Mv-.cjs")))
	},
	{
		"id": "sql",
		"name": "SQL",
		"import": (() => Promise.resolve().then(() => require("./sql-Bo9tHuSO.cjs")).then((n) => n.sql_exports))
	},
	{
		"id": "ssh-config",
		"name": "SSH Config",
		"import": (() => Promise.resolve().then(() => require("./ssh-config-CymYLIdK.cjs")))
	},
	{
		"id": "stata",
		"name": "Stata",
		"import": (() => Promise.resolve().then(() => require("./stata-DjNwUrfs.cjs")))
	},
	{
		"id": "stylus",
		"name": "Stylus",
		"aliases": ["styl"],
		"import": (() => Promise.resolve().then(() => require("./stylus-CVQUlw_W.cjs")))
	},
	{
		"id": "surrealql",
		"name": "SurrealQL",
		"aliases": ["surql"],
		"import": (() => Promise.resolve().then(() => require("./surrealql-B3VMAW86.cjs")))
	},
	{
		"id": "svelte",
		"name": "Svelte",
		"import": (() => Promise.resolve().then(() => require("./svelte-CLnPdr3d.cjs")))
	},
	{
		"id": "swift",
		"name": "Swift",
		"import": (() => Promise.resolve().then(() => require("./swift-vt36oa5K.cjs")))
	},
	{
		"id": "system-verilog",
		"name": "SystemVerilog",
		"import": (() => Promise.resolve().then(() => require("./system-verilog-B0zEvtf0.cjs")))
	},
	{
		"id": "systemd",
		"name": "Systemd Units",
		"import": (() => Promise.resolve().then(() => require("./systemd-CV0yPdBh.cjs")))
	},
	{
		"id": "talonscript",
		"name": "TalonScript",
		"aliases": ["talon"],
		"import": (() => Promise.resolve().then(() => require("./talonscript-DskfHWeo.cjs")))
	},
	{
		"id": "tasl",
		"name": "Tasl",
		"import": (() => Promise.resolve().then(() => require("./tasl-Cnnq7PFw.cjs")))
	},
	{
		"id": "tcl",
		"name": "Tcl",
		"import": (() => Promise.resolve().then(() => require("./tcl-D3TBj4xm.cjs")))
	},
	{
		"id": "templ",
		"name": "Templ",
		"import": (() => Promise.resolve().then(() => require("./templ-CcNrH-Sg.cjs")))
	},
	{
		"id": "terraform",
		"name": "Terraform",
		"aliases": ["tf", "tfvars"],
		"import": (() => Promise.resolve().then(() => require("./terraform-ChT_XRl7.cjs")))
	},
	{
		"id": "tex",
		"name": "TeX",
		"import": (() => Promise.resolve().then(() => require("./tex-Crf6Hqwc.cjs")))
	},
	{
		"id": "toml",
		"name": "TOML",
		"import": (() => Promise.resolve().then(() => require("./toml-DreLk0pe.cjs")))
	},
	{
		"id": "ts-tags",
		"name": "TypeScript with Tags",
		"aliases": ["lit"],
		"import": (() => Promise.resolve().then(() => require("./ts-tags-BvgdFZWY.cjs")))
	},
	{
		"id": "tsv",
		"name": "TSV",
		"import": (() => Promise.resolve().then(() => require("./tsv-DCaKojKH.cjs")))
	},
	{
		"id": "tsx",
		"name": "TSX",
		"import": (() => Promise.resolve().then(() => require("./tsx-nxW2N3nP.cjs")).then((n) => n.tsx_exports))
	},
	{
		"id": "turtle",
		"name": "Turtle",
		"import": (() => Promise.resolve().then(() => require("./turtle-DI420_YY.cjs")))
	},
	{
		"id": "twig",
		"name": "Twig",
		"import": (() => Promise.resolve().then(() => require("./twig-BPVXCVUr.cjs")))
	},
	{
		"id": "typescript",
		"name": "TypeScript",
		...
		"import": (() => Promise.resolve().then(() => require("./typescript-DYlSTaqa.cjs")).then((n) => n.typescript_exports))
	},
	{
		"id": "typespec",
		"name": "TypeSpec",
		"aliases": ["tsp"],
		"import": (() => Promise.resolve().then(() => require("./typespec-DqExUaGb.cjs")))
	},
	{
		"id": "typst",
		"name": "Typst",
		"aliases": ["typ"],
		"import": (() => Promise.resolve().then(() => require("./typst-BFEpozeX.cjs")))
	},
	{
		"id": "v",
		"name": "V",
		"import": (() => Promise.resolve().then(() => require("./v-NJbAAzG1.cjs")))
	},
	{
		"id": "vala",
		"name": "Vala",
		"import": (() => Promise.resolve().then(() => require("./vala-CUXKAr6F.cjs")))
	},
	{
		"id": "vb",
		"name": "Visual Basic",
		"aliases": ["cmd"],
		"import": (() => Promise.resolve().then(() => require("./vb-DCbe079M.cjs")))
	},
	{
		"id": "verilog",
		"name": "Verilog",
		"import": (() => Promise.resolve().then(() => require("./verilog-SNoAVGeg.cjs")))
	},
	{
		"id": "vhdl",
		"name": "VHDL",
		"import": (() => Promise.resolve().then(() => require("./vhdl-D2iOM5VV.cjs")))
	},
	{
		"id": "viml",
		"name": "Vim Script",
		"aliases": ["vim", "vimscript"],
		"import": (() => Promise.resolve().then(() => require("./viml-Du8fUOHD.cjs")))
	},
	{
		"id": "vue",
		"name": "Vue",
		"import": (() => Promise.resolve().then(() => require("./vue-2mnn3yR9.cjs")))
	},
	{
		"id": "vue-html",
		"name": "Vue HTML",
		"import": (() => Promise.resolve().then(() => require("./vue-html-KS2CSeAT.cjs")))
	},
	{
		"id": "vue-vine",
		"name": "Vue Vine",
		"import": (() => Promise.resolve().then(() => require("./vue-vine-C184PgN8.cjs")))
	},
	{
		"id": "vyper",
		"name": "Vyper",
		"aliases": ["vy"],
		"import": (() => Promise.resolve().then(() => require("./vyper-DLe-lTLs.cjs")))
	},
	{
		"id": "wasm",
		"name": "WebAssembly",
		"import": (() => Promise.resolve().then(() => require("./wasm-4MHoKv0u.cjs")))
	},
	{
		"id": "wenyan",
		"name": "Wenyan",
		"aliases": ["文言"],
		"import": (() => Promise.resolve().then(() => require("./wenyan-yCfadM9g.cjs")))
	},
	{
		"id": "wgsl",
		"name": "WGSL",
		"import": (() => Promise.resolve().then(() => require("./wgsl-Ofcf6fRf.cjs")))
	},
	{
		"id": "wikitext",
		"name": "Wikitext",
		"aliases": ["mediawiki", "wiki"],
		"import": (() => Promise.resolve().then(() => require("./wikitext-CdyKkT5y.cjs")))
	},
	{
		"id": "wit",
		"name": "WebAssembly Interface Types",
		"import": (() => Promise.resolve().then(() => require("./wit-CgFtwFib.cjs")))
	},
	{
		"id": "wolfram",
		"name": "Wolfram",
		"aliases": ["wl"],
		"import": (() => Promise.resolve().then(() => require("./wolfram-DouuOIGp.cjs")))
	},
	{
		"id": "xml",
		"name": "XML",
		"import": (() => Promise.resolve().then(() => require("./xml-CDKASfid.cjs")).then((n) => n.xml_exports))
	},
	{
		"id": "xsl",
		"name": "XSL",
		"import": (() => Promise.resolve().then(() => require("./xsl-D9wQxr19.cjs")))
	},
	{
		"id": "yaml",
		"name": "YAML",
		"aliases": ["yml"],
		"import": (() => Promise.resolve().then(() => require("./yaml-C19Nfqop.cjs")).then((n) => n.yaml_exports))
	},
	{
		"id": "zenscript",
		"name": "ZenScript",
		"import": (() => Promise.resolve().then(() => require("./zenscript-2eKnq_RY.cjs")))
	},
	{
		"id": "zig",
		"name": "Zig",
		"import": (() => Promise.resolve().then(() => require("./zig-DQ8RGCUH.cjs")))
	}
];
...
var bundledThemes = Object.fromEntries([
	{
		...
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./andromeeda-BYpHFsqf.cjs")))
	},
	{
		"id": "aurora-x",
		"displayName": "Aurora X",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./aurora-x-XloWwYvv.cjs")))
	},
	{
		"id": "ayu-dark",
		"displayName": "Ayu Dark",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./ayu-dark-CDYJs3lI.cjs")))
	},
	{
		"id": "ayu-light",
		"displayName": "Ayu Light",
		"type": "light",
		"import": (() => Promise.resolve().then(() => require("./ayu-light-BwkITGzB.cjs")))
	},
	{
		"id": "ayu-mirage",
		"displayName": "Ayu Mirage",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./ayu-mirage-BjbEwR4U.cjs")))
	},
	{
		"id": "catppuccin-frappe",
		"displayName": "Catppuccin Frappé",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./catppuccin-frappe-D1Bnv08N.cjs")))
	},
	{
		"id": "catppuccin-latte",
		"displayName": "Catppuccin Latte",
		"type": "light",
		"import": (() => Promise.resolve().then(() => require("./catppuccin-latte-O3pPW0J_.cjs")))
	},
	{
		"id": "catppuccin-macchiato",
		"displayName": "Catppuccin Macchiato",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./catppuccin-macchiato-BrOG3BlR.cjs")))
	},
	{
		"id": "catppuccin-mocha",
		"displayName": "Catppuccin Mocha",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./catppuccin-mocha-WLTSIIuo.cjs")))
	},
	{
		"id": "dark-plus",
		"displayName": "Dark Plus",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./dark-plus-GYOpsXkU.cjs")))
	},
	{
		"id": "dracula",
		"displayName": "Dracula Theme",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./dracula-Ct9tvNzm.cjs")))
	},
	{
		"id": "dracula-soft",
		"displayName": "Dracula Theme Soft",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./dracula-soft-B44ln0_X.cjs")))
	},
	{
		"id": "everforest-dark",
		"displayName": "Everforest Dark",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./everforest-dark-DVNgMlzP.cjs")))
	},
	{
		"id": "everforest-light",
		"displayName": "Everforest Light",
		"type": "light",
		"import": (() => Promise.resolve().then(() => require("./everforest-light-0cnDI7X0.cjs")))
	},
	{
		"id": "github-dark",
		"displayName": "GitHub Dark",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./github-dark-DqJl8av6.cjs")))
	},
	{
		"id": "github-dark-default",
		"displayName": "GitHub Dark Default",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./github-dark-default-D7SLSlWj.cjs")))
	},
	{
		"id": "github-dark-dimmed",
		"displayName": "GitHub Dark Dimmed",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./github-dark-dimmed-D-jPhbaq.cjs")))
	},
	{
		"id": "github-dark-high-contrast",
		"displayName": "GitHub Dark High Contrast",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./github-dark-high-contrast-B5a05pvG.cjs")))
	},
	{
		"id": "github-light",
		"displayName": "GitHub Light",
		"type": "light",
		"import": (() => Promise.resolve().then(() => require("./github-light-B-B4g3ie.cjs")))
	},
	{
		"id": "github-light-default",
		"displayName": "GitHub Light Default",
		"type": "light",
		"import": (() => Promise.resolve().then(() => require("./github-light-default-CN5KSa-P.cjs")))
	},
	{
		"id": "github-light-high-contrast",
		"displayName": "GitHub Light High Contrast",
		"type": "light",
		"import": (() => Promise.resolve().then(() => require("./github-light-high-contrast-CjCcvAgF.cjs")))
	},
	{
		"id": "gruvbox-dark-hard",
		"displayName": "Gruvbox Dark Hard",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./gruvbox-dark-hard-DXv9FYNk.cjs")))
	},
	{
		"id": "gruvbox-dark-medium",
		"displayName": "Gruvbox Dark Medium",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./gruvbox-dark-medium-DmbTOHEf.cjs")))
	},
	{
		"id": "gruvbox-dark-soft",
		"displayName": "Gruvbox Dark Soft",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./gruvbox-dark-soft-Cdlt6bB2.cjs")))
	},
	{
		"id": "gruvbox-light-hard",
		"displayName": "Gruvbox Light Hard",
		"type": "light",
		"import": (() => Promise.resolve().then(() => require("./gruvbox-light-hard-CdI9geii.cjs")))
	},
	{
		"id": "gruvbox-light-medium",
		"displayName": "Gruvbox Light Medium",
		"type": "light",
		"import": (() => Promise.resolve().then(() => require("./gruvbox-light-medium-C6Ec0COh.cjs")))
	},
	{
		"id": "gruvbox-light-soft",
		"displayName": "Gruvbox Light Soft",
		"type": "light",
		"import": (() => Promise.resolve().then(() => require("./gruvbox-light-soft-D0sv7KAK.cjs")))
	},
	{
		"id": "horizon",
		"displayName": "Horizon",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./horizon-HLgfHjpw.cjs")))
	},
	{
		"id": "horizon-bright",
		"displayName": "Horizon Bright",
		"type": "light",
		"import": (() => Promise.resolve().then(() => require("./horizon-bright-WXsdLqSI.cjs")))
	},
	{
		"id": "houston",
		"displayName": "Houston",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./houston-n51V2y1O.cjs")))
	},
	{
		"id": "kanagawa-dragon",
		"displayName": "Kanagawa Dragon",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./kanagawa-dragon-Bh0rMu0B.cjs")))
	},
	{
		"id": "kanagawa-lotus",
		"displayName": "Kanagawa Lotus",
		"type": "light",
		"import": (() => Promise.resolve().then(() => require("./kanagawa-lotus-D-Sa6_p8.cjs")))
	},
	{
		"id": "kanagawa-wave",
		"displayName": "Kanagawa Wave",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./kanagawa-wave-NnyKjUvj.cjs")))
	},
	{
		"id": "laserwave",
		"displayName": "LaserWave",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./laserwave-BsBqBfJJ.cjs")))
	},
	{
		"id": "light-plus",
		"displayName": "Light Plus",
		"type": "light",
		"import": (() => Promise.resolve().then(() => require("./light-plus-6qC38qCf.cjs")))
	},
	{
		"id": "material-theme",
		"displayName": "Material Theme",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./material-theme-pza7srpu.cjs")))
	},
	{
		"id": "material-theme-darker",
		"displayName": "Material Theme Darker",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./material-theme-darker-B_BLjC0_.cjs")))
	},
	{
		"id": "material-theme-lighter",
		"displayName": "Material Theme Lighter",
		"type": "light",
		"import": (() => Promise.resolve().then(() => require("./material-theme-lighter-DAzAIWGE.cjs")))
	},
	{
		"id": "material-theme-ocean",
		"displayName": "Material Theme Ocean",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./material-theme-ocean-CG1EO4Qi.cjs")))
	},
	{
		"id": "material-theme-palenight",
		"displayName": "Material Theme Palenight",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./material-theme-palenight-D0IMoH9S.cjs")))
	},
	{
		"id": "min-dark",
		"displayName": "Min Dark",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./min-dark-D0L9Fosi.cjs")))
	},
	{
		"id": "min-light",
		"displayName": "Min Light",
		"type": "light",
		"import": (() => Promise.resolve().then(() => require("./min-light-amLHFXLg.cjs")))
	},
	{
		"id": "monokai",
		"displayName": "Monokai",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./monokai-BASf_9Eh.cjs")))
	},
	{
		"id": "night-owl",
		"displayName": "Night Owl",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./night-owl-B1fwhTfu.cjs")))
	},
	{
		"id": "night-owl-light",
		"displayName": "Night Owl Light",
		"type": "light",
		"import": (() => Promise.resolve().then(() => require("./night-owl-light-Brgf8dQr.cjs")))
	},
	{
		"id": "nord",
		"displayName": "Nord",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./nord-JcnvBGpI.cjs")))
	},
	{
		"id": "one-dark-pro",
		"displayName": "One Dark Pro",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./one-dark-pro-D2UfstCz.cjs")))
	},
	{
		"id": "one-light",
		"displayName": "One Light",
		"type": "light",
		"import": (() => Promise.resolve().then(() => require("./one-light-DFiLD6YF.cjs")))
	},
	{
		"id": "plastic",
		"displayName": "Plastic",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./plastic-GyHG4DRv.cjs")))
	},
	{
		"id": "poimandres",
		"displayName": "Poimandres",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./poimandres-ByQ0Czni.cjs")))
	},
	{
		"id": "red",
		"displayName": "Red",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./red-CFQuX9eq.cjs")))
	},
	{
		"id": "rose-pine",
		"displayName": "Rosé Pine",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./rose-pine-CxLHDsJS.cjs")))
	},
	{
		"id": "rose-pine-dawn",
		"displayName": "Rosé Pine Dawn",
		"type": "light",
		"import": (() => Promise.resolve().then(() => require("./rose-pine-dawn-CaElF_f_.cjs")))
	},
	{
		"id": "rose-pine-moon",
		"displayName": "Rosé Pine Moon",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./rose-pine-moon-CKYT2tpl.cjs")))
	},
	{
		"id": "slack-dark",
		"displayName": "Slack Dark",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./slack-dark-CO9gQkN7.cjs")))
	},
	{
		"id": "slack-ochin",
		"displayName": "Slack Ochin",
		"type": "light",
		"import": (() => Promise.resolve().then(() => require("./slack-ochin-CddCKPy3.cjs")))
	},
	{
		"id": "snazzy-light",
		"displayName": "Snazzy Light",
		"type": "light",
		"import": (() => Promise.resolve().then(() => require("./snazzy-light-BPgVwR-q.cjs")))
	},
	{
		"id": "solarized-dark",
		"displayName": "Solarized Dark",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./solarized-dark-BPBFOmky.cjs")))
	},
	{
		"id": "solarized-light",
		"displayName": "Solarized Light",
		"type": "light",
		"import": (() => Promise.resolve().then(() => require("./solarized-light-De7oT7IH.cjs")))
	},
	{
		"id": "synthwave-84",
		"displayName": "Synthwave '84",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./synthwave-84-Dv0fE2W-.cjs")))
	},
	{
		"id": "tokyo-night",
		"displayName": "Tokyo Night",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./tokyo-night-ByrzXAtn.cjs")))
	},
	{
		"id": "vesper",
		"displayName": "Vesper",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./vesper-LgV0TnYR.cjs")))
	},
	{
		"id": "vitesse-black",
		"displayName": "Vitesse Black",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./vitesse-black-wolZAtYt.cjs")))
	},
	{
		"id": "vitesse-dark",
		"displayName": "Vitesse Dark",
		"type": "dark",
		"import": (() => Promise.resolve().then(() => require("./vitesse-dark-DepWMOBb.cjs")))
	},
	{
		"id": "vitesse-light",
		"displayName": "Vitesse Light",
		"type": "light",
		"import": (() => Promise.resolve().then(() => require("./vitesse-light-DdtkchyA.cjs")))
	}
].map((i) => [i.id, i.import]));
//#endregion
...
var { codeToHtml, codeToHast, codeToTokens, codeToTokensBase, codeToTokensWithThemes, getSingletonHighlighter, getLastGrammarState } = /* @__PURE__ */ createSingletonShorthands(/* @__PURE__ */ createBundledHighlighter({
	...
	engine: () => (0, engine_oniguruma_exports.createOnigurumaEngine)(Promise.resolve().then(() => require("./wasm-03yzfZw4.cjs")))
