...
var h = { ...e }, g = typeof document < "u" ? e.useLayoutEffect : () => {};
//#endregion
...
function b(e) {
	...
	if (e.length === 1) return C(e[0], v);
	let t = { ...C(e[0], v) };
	for (let n = 1; n < e.length; n += 1) t = x(t, e[n]);
	return t;
}
function x(e, t) {
	return S(t) ? t(e) : ee(e, t);
}
function ee(e, t) {
	if (!t) return e;
	for (let n in t) {
		...
		switch (n) {
			...
			case "className":
				e[n] = T(e.className, r);
				break;
			default: te(n, r) ? e[n] = ne(e[n], r) : e[n] = r;
		}
	}
	return e;
}
...
var D = E("https://base-ui.com/production-error", "Base UI"), O = /* @__PURE__ */ e.createContext(void 0);
process.env.NODE_ENV !== "production" && (O.displayName = "CompositeRootContext");
function k(t = !1) {
	let n = e.useContext(O);
	if (n === void 0 && !t) throw Error(process.env.NODE_ENV === "production" ? D(16) : "Base UI: CompositeRootContext is missing. Composite parts must be placed within <Composite.Root>.");
	return n;
}
//#endregion
...
function ae(t = {}) {
	let { disabled: n = !1, focusableWhenDisabled: r, tabIndex: i = 0, native: a = !0, composite: o } = t, s = e.useRef(null), c = k(!0), l = o ?? c !== void 0, { props: d } = ie({
	...
	let f = e.useCallback(() => {
		let e = s.current;
		A(e) && l && n && d.disabled === void 0 && e.disabled && (e.disabled = !1);
	}, [
		n,
		d.disabled,
		l
	...
	return g(f, [f]), {
		getButtonProps: e.useCallback((e = {}) => {
			...
			return y({
				...
				onKeyDown(e) {
					if (n || (w(e), o?.(e), e.baseUIHandlerPrevented)) return;
					let r = e.target === e.currentTarget, i = e.currentTarget, s = A(i), c = !a && oe(i), u = r && (a ? s : !c), d = e.key === "Enter", f = e.key === " ", p = i.getAttribute("role"), m = p?.startsWith("menuitem") || p === "option" || p === "gridcell";
					if (r && l && f) {
				...
				onKeyUp(e) {
					if (!n) {
						if (w(e), i?.(e), e.target === e.currentTarget && a && l && A(e.currentTarget) && e.key === " ") {
							e.preventDefault();
							return;
						}
...
var L;
process.env.NODE_ENV !== "production" && (L = /* @__PURE__ */ new Set());
function R(...e) {
	if (process.env.NODE_ENV !== "production") {
		let t = e.join(" ");
		L.has(t) || (L.add(t), console.warn(`Base UI: ${t}`));
	}
}
//#endregion
...
function de(e, t, n = {}) {
	let r = t.render, i = fe(t, n);
	return n.enabled === !1 ? null : me(e, r, i, n.state ?? V);
}
function fe(e, t = {}) {
	let { className: n, style: r, render: i } = e, { state: a = V, ref: o, props: s, stateAttributesMapping: c, enabled: l = !0 } = t, u = l ? B(n, a) : void 0, d = l ? ue(r, a) : void 0, f = l ? z(a, c) : V, p = l ? _(f, Array.isArray(s) ? b(s) : s) ?? V : V;
	return typeof document < "u" && (l ? Array.isArray(o) ? p.ref = ce([
		p.ref,
		I(i),
		...o
	]) : p.ref = se(p.ref, I(i), o) : se(null, null)), l ? (u !== void 0 && (p.className = T(p.className, u)), d !== void 0 && (p.style = _(p.style, d)), p) : V;
}
var pe = Symbol.for("react.lazy");
function me(t, n, r, i) {
	if (n) {
		if (typeof n == "function") return process.env.NODE_ENV !== "production" && he(n), n(r, i);
		let t = y(r, n.props);
		t.ref = r.ref;
		let a = n;
		if (a?.$$typeof === pe && (a = e.Children.toArray(n)[0]), process.env.NODE_ENV !== "production" && !/* @__PURE__ */ e.isValidElement(a)) throw Error([
	...
	if (t && typeof t == "string") return ge(t, r);
	throw Error(process.env.NODE_ENV === "production" ? D(8) : "Base UI: Render element or function are not defined.");
}
function he(e) {
	let t = e.name;
	if (t.length === 0) return;
	let n = t.charCodeAt(0);
	n < 65 || n > 90 || R(`The \`render\` prop received a function named \`${t}\` that starts with an uppercase letter.`, "This usually means a React component was passed directly as `render={Component}`.", "Base UI calls `render` as a plain function, which can break the Rules of Hooks during reconciliation.", "If this is an intentional render callback, rename it to start with a lowercase letter.", "Use `render={<Component />}` or `render={(props) => <Component {...props} />}` instead.", "https://base-ui.com/r/invalid-render-prop");
}
function ge(n, r) {
...
var _e = /* @__PURE__ */ e.forwardRef(function(e, t) {
	let { render: n, className: r, disabled: i = !1, focusableWhenDisabled: a = !1, nativeButton: o = !0, ...s } = e, { getButtonProps: c, buttonRef: l } = ae({
		disabled: i,
...
process.env.NODE_ENV !== "production" && (_e.displayName = "Button");
//#endregion
...
var be = (e) => typeof e == "boolean" ? `${e}` : e === 0 ? "0" : e, xe = ye, Se = (e, t) => (n) => {
	...
	let { parseClassName: n, getClassGroupId: r, getConflictingClassGroupIds: i, sortModifiers: a } = t, o = [], s = e.trim().split(Je), c = "";
	for (let e = s.length - 1; e >= 0; --e) {
		...
		let g = u.length === 0 ? "" : u.length === 1 ? u[0] : a(u).join(":"), _ = d ? g + Ve : g, v = _ + h;
...
}, et = /^\[(?:(\w[\w-]*):)?(.+)\]$/i, tt = /^\((?:(\w[\w-]*):)?(.+)\)$/i, nt = /^\d+(?:\.\d+)?\/\d+(?:\.\d+)?$/, rt = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, it = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, at = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/, ot = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, st = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, W = (e) => nt.test(e), G = (e) => !!e && !Number.isNaN(Number(e)), K = (e) => !!e && Number.isInteger(Number(e)), ct = (e) => e.endsWith("%") && G(e.slice(0, -1)), q = (e) => rt.test(e), lt = () => !0, ut = (e) => it.test(e) && !at.test(e), dt = () => !1, ft = (e) => ot.test(e), pt = (e) => st.test(e), mt = (e) => !J(e) && !X(e), ht = (e) => Q(e, At, dt), J = (e) => et.test(e), Y = (e) => Q(e, jt, ut), gt = (e) => Q(e, Mt, G), _t = (e) => Q(e, Pt, lt), vt = (e) => Q(e, Nt, dt), yt = (e) => Q(e, Ot, dt), bt = (e) => Q(e, kt, pt), xt = (e) => Q(e, Ft, ft), X = (e) => tt.test(e), Z = (e) => $(e, jt), St = (e) => $(e, Nt), Ct = (e) => $(e, Ot), wt = (e) => $(e, At), Tt = (e) => $(e, kt), Et = (e) => $(e, Ft, !0), Dt = (e) => $(e, Pt, !0), Q = (e, t, n) => {
	let r = et.exec(e);
...
var Rt = Se("group/button inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4", {
	variants: {
		variant: {
...
function zt({ className: e, variant: t = "default", size: r = "default", ...i }) {
...
//#endregion
export { zt as Button, Rt as buttonVariants, Lt as cn };
