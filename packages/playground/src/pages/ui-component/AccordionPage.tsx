		...
		<div className="w-full space-y-3">
			...
			>
				...
				<AccordionItem value="item-2">
					...
					<AccordionContent>
						구매 후 30일 이내에 미사용 상태의 제품을 반품하시면 전액 환불해 드립니다. 반품 운송비는
						고객 부담입니다.
					</AccordionContent>
				</AccordionItem>
				<AccordionItem value="item-3">
					...
					<AccordionContent>
						이메일(support@example.com), 전화(평일 오전 9시 ~ 오후 6시), 또는 채팅을 통해 문의하실 수
						있습니다.
					</AccordionContent>
				</AccordionItem>
			</Accordion>
		...
		<div className="space-y-10 max-w-2xl">
			<div>
				...
				<p className="text-sm text-muted-foreground mt-1">
					<code className="bg-muted px-1 rounded text-xs">@nic/mfe-lib-shared</code> 에서 제공하는
					아코디언 컴포넌트입니다. 각 항목을 클릭하면 내용이 펼쳐집니다.
				</p>
			</div>
				...
				<div className="rounded-lg border p-6">
					<Accordion defaultValue={['basic-1']}>
						<AccordionItem value="basic-1">
							...
							<AccordionContent>
								로그인 페이지에서 '비밀번호 찾기'를 클릭하고 이메일 주소를 입력하면 재설정 링크를
								보내드립니다. 링크는 24시간 후 만료됩니다.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem value="basic-2">
							<AccordionTrigger>구독 플랜을 변경할 수 있나요?</AccordionTrigger>
							<AccordionContent>
								네, 언제든지 계정 설정에서 플랜을 업그레이드하거나 다운그레이드할 수 있습니다. 변경
								사항은 다음 청구 주기부터 적용됩니다.
							</AccordionContent>
						</AccordionItem>
				...
				<div className="rounded-lg border p-6">
					<Accordion multiple defaultValue={['multi-1', 'multi-3']}>
						<AccordionItem value="multi-1">
							...
							<AccordionContent>
								이메일 알림, 푸시 알림, SMS 알림을 개별적으로 설정할 수 있습니다. 알림 빈도와 수신
								시간대도 지정 가능합니다.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem value="multi-2">
							...
							<AccordionContent>
								2단계 인증을 활성화하고 로그인 기록을 확인하세요. 연결된 앱과 기기를 관리할 수
								있습니다.
							</AccordionContent>
						</AccordionItem>
				...
				<div className="rounded-lg border p-6">
					<Accordion>
						...
						<AccordionItem value="disabled-3">
							...
							<AccordionContent>
								계정 설정 &gt; 프로필에서 이메일 주소를 변경할 수 있습니다. 변경 후 인증 이메일이
								발송됩니다.
							</AccordionContent>
						</AccordionItem>
					</Accordion>
				...
				<div className="rounded-lg border p-6">
					<Accordion className="border rounded-lg">
						...
						>
							...
							<AccordionContent>
								월간 및 연간 구독 플랜을 제공합니다. 각 주기 시작 시 청구되며, 언제든지 취소할 수
								있습니다. 모든 플랜에 자동 백업, 24/7 지원, 무제한 팀원이 포함됩니다.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem
							value="border-2"
						...
						>
							...
							<AccordionContent>
								모든 데이터는 AES-256 암호화로 저장되며, 전송 시에는 TLS를 사용합니다. 정기적인 보안
								감사를 실시합니다.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem
